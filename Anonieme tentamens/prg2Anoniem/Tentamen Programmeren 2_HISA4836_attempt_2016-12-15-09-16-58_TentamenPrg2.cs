...
namespace Tentamens20162017
{
    class TentamenPrg2Tentamen20162017
    {
        ...
        public bool Vraag1(string s1, string s2)
        {
            ...
            /* Je moet kijken hoe de indexen staan en deze door de loop heen halen wanneer de index
             * nog het zelfde is wanneer hij omgedraaid is True returen anders false*/
        }
        ...
        private void Vraag3(double[] xs)
        {
            ...
            /* je moet de index pakken van inputOutput deze eerste 3 bij elkaar optellen in een
             * for loop daarna door drie delen en in nieuw array zetten dan de andere for loop +1 en zo door gaan tot de laatste */
        }
        ...
        /* je telt eerst hoeveel leerlingen examen hebben gedaan en erzijn in een foreach loop 
         * daarna kijk je in de list exam met nog een for each loop en doe je de count ++
         * hierna krijg je een grootste count en deze return je*/
    }
}/* huilen met de pet op GG have fun im out *mic drop* */
