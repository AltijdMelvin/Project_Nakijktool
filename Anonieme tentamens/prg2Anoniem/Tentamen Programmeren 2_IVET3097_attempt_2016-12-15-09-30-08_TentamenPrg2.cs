...
namespace Tentamens20162017
{
    class TentamenPrg2Tentamen20162017
    {
        ...
        public List<int> Vraag4(int k)
        {
            ...
            for (int n = 0, f = 1; f < k; result.Add(f), n++, f = n * result[n - 1]) // Mag dit?
                ;
                                            ...
                                            List<Exam> exams)
        {
            ...
            foreach (Course course in courses)
            {
                ...
                if (count > mostCount)
                {
                    mostCourseName = course.Name;
                    mostCount = count;
                }
            }

            return mostCourseName;
        }
    }
}
