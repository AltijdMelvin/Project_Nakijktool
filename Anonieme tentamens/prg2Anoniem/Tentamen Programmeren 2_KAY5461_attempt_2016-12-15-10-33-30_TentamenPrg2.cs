...
namespace Tentamens20162017
{
    class TentamenPrg2Tentamen20162017
    {
        ...
        {
            double meting, buurLinks, buurRechts, gemiddelde = 0;
            double temp = xs[0];
            ...
            for (int i = 1; i < xs.Length-1; i++)
            {
                ...
                buurLinks = temp;
                temp = xs[i];
                gemiddelde = (meting + buurRechts + buurLinks) / 3;
        ...
        public List<int> Vraag4(int k)
        {
            ...
            for (int i = 1; i <= k; i++)
            {
                ...
                if (faculteit < 2 && faculteit > 0)
                {
                    lijstje.Add(faculteit);
                }

                if (faculteit < k && faculteit > 0)
                {
                    lijstje.Add(faculteit);
                }
            }
                                            ...
                                            List<Exam> exams)
        {
            ...
            for (int i = 0; i < courses.Count; i++)
            {
                ...
                {
                    if(courses[i].Name == exams[j].Course.Name)
                    {
                        count++;
                    }
                }
