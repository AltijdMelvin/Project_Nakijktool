...
namespace TentamenPrg3_1_2016_2017
{
    #region Vraag1
    //Vraag 1A
    // De constructor dient ervoor om variabelen te intalitiseren
    //

    //Vraag 1B
    //Lijn(lijnNr : int), Bus(busNr : int) Halte(naam : string, reisduur : TimeSpan)
    //

    //Vraag 1C
    //instantie variabelen zijn altijd prive, dit is om ze te beschermen tegen de buitenwereld. 
    //propertys zijn altijd public, deze vormen het contact met de buitenwereld. Hierdoor kunnen dingen worden aangepast.
    #endregion
