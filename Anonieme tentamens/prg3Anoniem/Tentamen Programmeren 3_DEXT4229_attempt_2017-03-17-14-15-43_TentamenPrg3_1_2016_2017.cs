...
namespace TentamenPrg3_1_2016_2017
{
    #region Vraag1
    //Vraag 1A
    //een bewerking uitvoeren met de instantie variabelen.
    //

    //Vraag 1B
    //Lijn,Addhalte,Reistijd,Halte,Bus,StapIn,StapUit.
    //

    //Vraag 1C
    //property's zijn public en instantie variabele zijn private.
    //
    #endregion
