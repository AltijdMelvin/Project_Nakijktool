...
namespace TentamenPrg3_1_2016_2017
{
    #region Vraag1
    //Vraag 1A
    //Het doel van een constructor is het aangeven wat de ene class te maken heeft met een ander.
    //
    ...
    //Vraag 1C
    //Property heeft gegevens, zoals bijv. een ballon die o.a. een kleur , een vorm en een volume heeft en dat 
    //is niet het geval bij een instantie.
    //
    #endregion
