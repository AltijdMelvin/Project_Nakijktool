...
namespace TentamenPrg3_1_2016_2017
{
    #region Vraag1
    //Vraag 1A
    // De klasse initialiseren met een standaardwaarde zodat deze gebruikt kan worden in het programma.
    //

    //Vraag 1B
    // public Lijn, public Bus en public Halte.
    //

    //Vraag 1C
    // Een property is in het gehele programma bekend en te zien, een instantievariabele is alleen in de klasse zelf te benaderen.
    //
    #endregion
