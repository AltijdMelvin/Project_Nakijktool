...
namespace TentamenPrg3_1_2016_2017
{
    #region Vraag1
    //Vraag 1A
    // Een constructor wordt wordt bij het creëren van een object aangeroepen, en voert alle initialisaties uit zoals bijv. het toekennen van beginwaarden aan variabelen.
    //
    ...
    //Vraag 1C
    // Een property maakt mogelijk om als gebruiker toegang te krijgen tot de toestand van een object, en deze eventueel te wijzigen.
    // Properties zijn dus public. Instantievariabelen zijn private en kunnen niet door de gebruiker gewijzigd worden.
    #endregion
