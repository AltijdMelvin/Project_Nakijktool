...
namespace TentamenPrg3_1_2016_2017
{
    #region Vraag1
    //Vraag 1A
    // Het klaar zetten van gegevens van een object
    //

    //Vraag 1B
    // Onder Bus Bus, onder Lijn Lijn en onder Halte Halte
    //

    //Vraag 1C
    // Een instantie variable is altijd private 
    // een property niet
    #endregion
    ...
    public class LijnLinked
    {
        ...
        public int Count
        {
            get
            {
                ...
                HalteLinked OudeHalte = top;
                if (OudeHalte.Volgende != OudeHalte)
                {
                    count++;
                    OudeHalte = OudeHalte.Volgende;                    
                }
                return count;
