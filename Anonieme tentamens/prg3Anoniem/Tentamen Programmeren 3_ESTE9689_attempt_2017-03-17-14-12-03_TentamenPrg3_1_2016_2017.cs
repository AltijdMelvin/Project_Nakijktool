...
namespace TentamenPrg3_1_2016_2017
{
    #region Vraag1
    //Vraag 1A
    // Een constructor zet de instantie variabelen en properites klaar, door ze inhoud te geven enz., zodat ze gebruikt kunnen worden in het programma.
    //

    //Vraag 1B
    // Lijn, Bus, Halte
    // * Deze staan in de blokken en zjin niet de naam van het blok zelf, in het uml diagram.

    //Vraag 1C
    // Een instantie variabele verschilt van een property, in het opzicht dat je van een property een read of write only
    // kan maken, een instantie variabele die hoort op private te staan zodat je hem niet zomaar in de code kan veranderen.
    #endregion
