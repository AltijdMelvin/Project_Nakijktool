...
namespace TentamenPrg3_1_2016_2017
{
    #region Vraag1
    //Vraag 1A
    //Het uitvoeren van code op een andere plek, zodat alles overzichtelijker blijft.
    //

    //Vraag 1B
    //Addhalte, StapIn, StapUit
    //

    //Vraag 1C
    //een property is publiek, die kan je bereiken ook uit andere delen van de solution. een instantie variabele is private, die kan je alleen bereiken uit een bepaalde class
    //
    #endregion
