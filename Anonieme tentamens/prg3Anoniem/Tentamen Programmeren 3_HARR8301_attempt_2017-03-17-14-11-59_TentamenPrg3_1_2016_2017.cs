...
namespace TentamenPrg3_1_2016_2017
{
    #region Vraag1
    //Vraag 1A
    // waardes initializeren en instanties van klassen creëren
    //
    ...
    //Vraag 1C
    //een instantievariabele is altijd private zodat het niet zomaar aangepast kan worden.
    //een propertie geeft toegang tot de gegevens bij een object op een gecontroleerde manier.
    #endregion
    ...
    public class HalteStack
    {
        ...
        {
            HalteStack.Add(halteNaam);
        }

        public string Pop()
        {
            foreach(Halte in HalteStack)
            {
