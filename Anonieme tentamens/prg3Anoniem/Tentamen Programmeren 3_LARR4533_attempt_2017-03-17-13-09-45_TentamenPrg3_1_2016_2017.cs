...
namespace TentamenPrg3_1_2016_2017
{
    #region Vraag1
    //Vraag 1A
    //Om instancie variable van een classe een waarde te geven en te instancieren.
    //
    ...
    //Vraag 1C
    // Een property kan waarden ophalen en setten.
    // Een instancie variable is het gene waar een property de warden van set
    #endregion
