...
namespace TentamenPrg3_1_2016_2017
{
    #region Vraag1
    //Vraag 1A
    // Het doel van een constructor is om een instantie van een class aan te maken en daarbij
    // eventueel een waarde toe te kennen aan instantie variabelen.

    //Vraag 1B
    // Lijn(lijnNr: int), Halte(naam: string, reisduur: TimeSpan),
    // Bus(busNr: int, lijn: Lijn, vertrektijd: DateTime, voornaam: string, achternaam: string.

    //Vraag 1C
    // Het verschil tussen een property en een instantie variabele is dat een instantie variabele alleen toegankelijk
    // is voor de code in de class zelf, terwijl een property ook toegankelijk is in de rest van het programma.
    #endregion
