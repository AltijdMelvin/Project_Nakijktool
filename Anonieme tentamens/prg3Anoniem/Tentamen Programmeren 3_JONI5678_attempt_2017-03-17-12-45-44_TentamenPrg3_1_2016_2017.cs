...
namespace TentamenPrg3_1_2016_2017
{
    #region Vraag1
    //Vraag 1A
    // Met een construtor kan je de instantie variables setten, doormiddel van de parameters die je mee geeft als je een instantie van de klas maakt.
    //
    ...
    //Vraag 1C
    //Een instantie variabele is private, die kun je alleen maar in de class gebruiken. Een property is public, waarmee je die instatie variabele doorsluist.
    //
    #endregion
    ...
    public class LijnLinked
    {
        ...
        public int Count
        {
            ...
            {
                int count = 0;
                HalteLinked countTop = top;
                while (countTop != null)
                {
                    count++;
                    countTop = countTop.Volgende;
                }
                return count;
            }
        }
