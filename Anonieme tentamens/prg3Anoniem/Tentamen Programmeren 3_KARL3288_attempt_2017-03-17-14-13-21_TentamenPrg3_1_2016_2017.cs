...
namespace TentamenPrg3_1_2016_2017
{
    #region Vraag1
    //Vraag 1A
    // het doel van een constructor is het aangeven wat een class is.
    //
    ...
    //Vraag 1C
    // een property is iets wat een voorwerp heeft bijvoorbeeld een bus heeft een lengte dan is lengte een property van een bus,
    // een instantie variable is wat de lengte is, de lengte kan verschillen per bus.
    #endregion
