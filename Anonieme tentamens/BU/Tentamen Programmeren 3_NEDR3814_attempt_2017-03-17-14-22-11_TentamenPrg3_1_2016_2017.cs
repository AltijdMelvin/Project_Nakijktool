...
namespace TentamenPrg3_1_2016_2017
{
    #region Vraag1
    //Vraag 1A
    //Hier kan je je objected waardes geven zoals bij bus, die heeft een stuk of wat variabelen die hij mee
    // moet nemen voor bv wanneer we Bus bus callen

    //Vraag 1B
    // in Lijn: Lijn en Reistijd, in Bus: bus en in Halte: halte.
    //

    //Vraag 1C
    // een property heeft een { get; set;} value, een instantie variabele heeft zijn eigen waarde.
    //
    #endregion
