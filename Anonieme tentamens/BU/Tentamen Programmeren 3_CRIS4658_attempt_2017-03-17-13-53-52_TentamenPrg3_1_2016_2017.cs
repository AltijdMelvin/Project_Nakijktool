...
namespace TentamenPrg3_1_2016_2017
{
    #region Vraag1
    //Vraag 1A
    // In de constructor zet je de het programma en de instantievariabelen klaar voor gebruik
    //

    //Vraag 1B
    //in lijn: Lijn(lijnNr:int), in Bus: Bus(busNr: int, lijn: Lijn, vertrektijd: DateTime, voornaam: string, achternaam: String), in halte: Halte(naam:string, reisduur: TimeSpan)
    //

    //Vraag 1C
    // Een instantievariabele is private en mag buiten de class zelf niet beschikbaar zijn. Een property maak je om buiten de class toch, eventueel beperkt, toegang te geven tot de variabelen.
    //
    #endregion
