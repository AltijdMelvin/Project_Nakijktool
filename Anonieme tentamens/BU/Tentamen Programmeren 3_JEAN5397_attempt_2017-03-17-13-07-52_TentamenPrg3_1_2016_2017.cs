...
namespace TentamenPrg3_1_2016_2017
{
    #region Vraag1
    //Vraag 1A
    //Een constructor bevat variabelen. En kan je oproepen. Dit doe je door values te geven aan de variabelen in de opgegeven constructor.
    //
    ...
    //Vraag 1C
    //Een instantievariabele is niet aanpasbaar en is private en staat bovenaan de class, een property kan je getten en setten. Dus kan je zelf zeggen als hij aanpasbaar is of niet.
    //
    #endregion
