...
namespace TentamenPrg3_1_2016_2017
{
    #region Vraag1
    //Vraag 1A
    // Een constructor vult de instantie variabelen van een class.
    // Wordt de constructor van buiten de class aangeroepen dan kunnen de variabelen in een keer gevult worden
    //wanneer er genoeg waardes zijn mee gegeven anders niet.

    //Vraag 1B
    // Lijn in de class Lijn
    // Bus in de class Bus
    // Halte in de class Halte

    //Vraag 1C
    // Een instatie variabele is een variabele van de class en kan niet van buiten de class benaderd worden.
    // Een propertie vult deze instantie variabelen of/en returned ze en is wel van buiten de class te benaderen.
