...
namespace TentamenPrg3_1_2016_2017
{
    #region Vraag1
    //Vraag 1A
    // Wanneer een instantie van een klasse wordt gemaakt wordt als eerst van de functies de constructor uitgevoerd.
    // De doel van de constructor is om automatisch uitgevoerd te worden wanneer een instantie van de klasse wordt gemaakt.
    // In de constructor kan bijvoorbeeld de waardes mee gegeven worden via parameters.
    ...
    //Vraag 1C
    // Property heeft getters en setters en een instantie variable is.
    //
    #endregion
