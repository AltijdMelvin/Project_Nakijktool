...
namespace TentamenPrg3_1_2016_2017
{
    #region Vraag1
    //Vraag 1A
    // om de externe variable intern te maken.
    // bijv. this.naam = naam;

    //Vraag 1B
    // public Lijn {} , Public bus {} , Public Halte {}
    // 

    //Vraag 1C
    // een property kun je get and set 'en en een instantie variable kan dat niet.
    //
    #endregion
    ...
    public class LijnLinked
    {
        ...
        public int Count
        {
            ...
            {
                int count = 0;
                // for each time top.volgende changes do count++
                return count;
            }
        }
        ...
        public TimeSpan Reistijd()
        {
            TimeSpan reistijd = new TimeSpan();
            reistijd = top.Reisduur;
            return reistijd;
        }
    }
