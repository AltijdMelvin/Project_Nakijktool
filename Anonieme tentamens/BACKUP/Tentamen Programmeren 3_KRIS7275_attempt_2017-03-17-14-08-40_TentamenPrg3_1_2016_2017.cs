...
namespace TentamenPrg3_1_2016_2017
{
    #region Vraag1
    //Vraag 1A
    // Een constructor zorgt er voor dat de variabelen private blijven en dat 
    // ze niet zomaar gewijzigd kunnen worden binnen het programma.
    ...
    //Vraag 1C
    // properties zijn eigenschappen van bijvoorbeeld een class 
    //instance variable zet je er this. voor en bij properties niet die zijn public
    #endregion
