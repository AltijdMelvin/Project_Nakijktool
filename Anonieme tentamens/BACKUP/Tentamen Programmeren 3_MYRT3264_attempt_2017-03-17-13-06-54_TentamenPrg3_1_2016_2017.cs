...
namespace TentamenPrg3_1_2016_2017
{
    #region Vraag1
    //Vraag 1A
    //Constructor gebruik je om een instantie te maken van een class.
    //
    ...
    //Vraag 1C
    //Een instantie variable is een variable die normaal private is en niet van buiten aanpast.
    //Property is normaal public een gebruik je vaak om instantie variable aan te passen van buiten af.
    #endregion
